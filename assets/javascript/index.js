    ...
    let searchInputs = `
      <div class="col-md-6">
              <input
                ...
                placeholder="Search By The Name Of The Choosing Meal"
              />
            </div>
            <div class="col-md-6">
              <input
                ...
                placeholder="Search By The First Letter Of The Name Of The Meal"
              />
            </div>
    `;
              ...
              <div class="row g-3">
                <div class="col-md-6">
                  ...
                  <p class="mt-3 fw-bold d-none text-danger alert alert-danger" id="nameWarning">
                    You Should Take care That In This Field , You Must Not Use Special characters and numbers not allowed!
                  </p>
                </div>
                <div class="col-md-6">
                  <input
                  ...
                  <p class="mt-3 fw-bold d-none text-danger alert alert-danger" id="emailWarning">
                    Email not valid! , Because Email Must Start With Some English Letters From A To Z And Some Numbers , And After That @ Symbol At The End Of The Email Must Use .com , In The Email Must Not Use Any Special Character Else "@" , Because It Is Invalid In Email
                  </p>
                </div>
                <div class="col-md-6">
                  <input
                    type="text"
                    placeholder="Please Enter Your Correct Phone"
                  ...
                  <p class="mt-3 fw-bold d-none text-danger alert alert-danger" id="phoneWarning">
                    Enter valid Phone Number , You Must Start With +02 , And After +02 You Must Use Only One Of The Code Number Like 010 , 011 , 012 , Or 015 , And Then Complete Eleven Numbers 
                  </p>
                </div>
                <div class="col-md-6">
                  <input
                  ...
                  <p class="mt-3 fw-bold d-none text-danger alert alert-danger" id="ageWarning">
                    Enter valid age , You Must Not Use Special Characters , Letters , Or Any Symbols In This Field
                  </p>
                </div>
                <div class="col-md-6">
                  <input
